    ...
    <div class="modal fade" id="quantityModal" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="modal_item_quantity" required>
                    </div>
                    <div class="form-group">
                        <label for="product_price">Price per Item</label>
                        <input type="text" class="form-control" id="modal_product_price" readonly>
                    </div>
                    <div class="form-group">
                        <label for="total_price">Total Price</label>
                        <input type="text" class="form-control" id="modal_total_price" readonly>
                    </div>
                    <div class="form-group">
                        <label for="order_status">Status</label>
                        <input type="text" class="form-control" id="modal_order_status" value="Walk-in" readonly>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="confirmOrderDetails">Confirm</button>
            </div>
        </div>
    </div>
    </div>

<div class="iq-sidebar  sidebar-default ">
    <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
        <a href="dashboard.php" class="header-logo">
            <img src="../assets/images/gra.png" class="img-fluid rounded-normal light-logo" alt="logo">
            <h5 class="logo-title light-logo ml-3">G.A. Ruiz Enterprise </h5>
        </a>
        ...
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <ul id="product" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li class="">
                            <a href="list-product.php">
                                <i class="las la-minus"></i><span>List of Product</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" ">
                    ...
                    <li class="">
                            <a href="walk-in.php">
                                <i class="las la-minus"></i><span>Walk In</span>
                            </a>
                        </li>

                        <li class="">
                            <a href="list-of-orders.php">
                                <i class="las la-minus"></i><span>List of Orders</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="list-of-delivered.php">
                                <i class="las la-minus"></i><span>List of Delivered</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" ">
                    <a href="#people" class="collapsed" data-toggle="collapse" aria-expanded="false">
                        ...
                        <span class="ml-4">Normal Users</span>
                        <svg class="svg-icon iq-arrow-right arrow-active" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="10 15 15 20 20 15"></polyline>
                            <path d="M4 4h7a4 4 0 0 1 4 4v12"></path>
                        </svg>
                    ...
                    <ul id="people" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="">
                            <a href="list-of-customer-account.php">
                                <i class="las la-minus"></i><span>List of Customer Account</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="add-customer-account.php">
                                <i class="las la-minus"></i><span>Add Customers Account</span>
                            </a>
                        </li>
                        <!--li class="">
                ...
                <li class=" ">
                    <a href="#admin" class="collapsed" data-toggle="collapse" aria-expanded="false">
                        ...
                        <span class="ml-4">Admin Users</span>
                        <svg class="svg-icon iq-arrow-right arrow-active" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="10 15 15 20 20 15"></polyline>
                            <path d="M4 4h7a4 4 0 0 1 4 4v12"></path>
                        </svg>
                    ...
                    <ul id="admin" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="">
                            <a href="list-of-admin-account.php">
                                <i class="las la-minus"></i><span>List of Admin Account</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="add-admin-account.php">
                                <i class="las la-minus"></i><span>Add Admin Account</span>
                            </a>
                        </li>
                        <!--li class="">
                                          <a href="../backend/page-list-users.html">

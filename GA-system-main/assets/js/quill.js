    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function matchAttributor(node, delta) {
          ...
          if (Object.keys(formats).length > 0) {
            delta = delta.compose(
              new _quillDelta2.default().retain(delta.length(), formats)
            );
          }
          return delta;
        }
        ...
        var Keyboard = (function (_Module) {
          ...
          function Keyboard(quill, options) {
            ...
            if (/Trident/i.test(navigator.userAgent)) {
              _this.addBinding(
                { key: Keyboard.keys.BACKSPACE, shortKey: true },
                handleBackspace
              );
              _this.addBinding(
                { key: Keyboard.keys.DELETE, shortKey: true },
                handleDelete
              );
            }
            _this.listen();
          ...
          bindings: {
            ...
            "checklist enter": {
              ...
              handler: function handler(range) {
                ...
                var _quill$scroll$line3 = this.quill.scroll.line(
                    range.index + 1
                  ),

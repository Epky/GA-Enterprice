<x-admin-layout>
    ...
    <script>
        ...
        function populateReview() {
            ...
            const newImageCount = document.getElementById('images') ? document.getElementById('images').files.length : 0;
            reviewHtml += `
                <div>

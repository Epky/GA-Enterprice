            ...
            <div class="text-center max-w-4xl mx-auto">
                ...
                <form method="GET" action="{{ route('customer.dashboard') }}" class="max-w-3xl mx-auto" role="search" aria-label="Product search">
                    <div class="flex flex-col sm:flex-row gap-3 shadow-2xl rounded-2xl overflow-hidden">
                        ...
                        <button type="submit" aria-label="Submit search" class="px-8 py-4 bg-white text-purple-700 font-bold hover:bg-pink-50 transition-all duration-200 min-h-[56px] min-w-[56px] rounded-2xl sm:rounded-l-none flex items-center justify-center gap-2">

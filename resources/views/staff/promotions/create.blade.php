<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('staff.promotions.store') }}">
                @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="promotion_type" id="promotion_type" 
                                    ...
                                    <option value="percentage" {{ old('promotion_type') == 'percentage' ? 'selected' : '' }}>Percentage Discount</option>
                                    <option value="fixed_amount" {{ old('promotion_type') == 'fixed_amount' ? 'selected' : '' }}>Fixed Amount Discount</option>
                                    <option value="bogo" {{ old('promotion_type') == 'bogo' ? 'selected' : '' }}>Buy One Get One</option>
                                    <option value="free_shipping" {{ old('promotion_type') == 'free_shipping' ? 'selected' : '' }}>Free Shipping</option>
                                </select>
                            </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select name="applicable_to" id="applicable_to" 
                                    ...
                                    <option value="category" {{ old('applicable_to') == 'category' ? 'selected' : '' }}>Specific Categories</option>
                                    <option value="brand" {{ old('applicable_to') == 'brand' ? 'selected' : '' }}>Specific Brands</option>
                                    <option value="product" {{ old('applicable_to') == 'product' ? 'selected' : '' }}>Specific Products</option>
                                </select>
                            </div>
    ...
    <script>
        ...
        function toggleApplicableIds() {
            ...
            categorySelect.querySelector('select').selectedIndex = -1;
            brandSelect.querySelector('select').selectedIndex = -1;
            productSelect.querySelector('select').selectedIndex = -1;

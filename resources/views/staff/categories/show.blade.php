                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            @if($category->display_image)
                                <div class="mb-4">
                                    <img src="{{ asset('storage/' . $category->display_image) }}" alt="{{ $category->name }}" class="h-48 w-48 object-cover rounded shadow-md">
                                    @if(!$category->image_url)
                                        <p class="text-xs text-gray-500 mt-2">
                                            <i class="fas fa-info-circle"></i> Auto-displayed from product images
                                        </p>
                                    @endif
                                </div>
                            @else
                                <div class="mb-4 h-48 w-48 bg-gray-100 rounded flex items-center justify-center">

    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('staff.brands.update', $brand) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" id="description" rows="4" 
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('description') border-red-500 @enderror">{{ old('description', $brand->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-6">
                            ...
                            @if($brand->logo_url)
                                <div class="mb-2">
                                    <img src="{{ $brand->logo_url }}" alt="{{ $brand->name }}" class="h-24 w-24 object-contain">
                                </div>
                            @endif
                            <input type="url" name="logo_url" id="logo_url" value="{{ old('logo_url', $brand->logo_url) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="meta_description" id="meta_description" rows="3" 
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('meta_description') border-red-500 @enderror">{{ old('meta_description', $brand->meta_description) }}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            @if($brand->product_count > 0)
                                <p class="mt-1 text-sm text-yellow-600">
                                    ...
                                    This brand has {{ $brand->product_count }} products. Deactivating will hide them from customers.
                                </p>
                            @endif
                        </div>
                            ...
                            <div class="mb-6">
                                <label class="flex items-center">
                                    <input type="checkbox" name="confirm_deactivation" value="1"
                                        class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    <span class="ml-2 text-sm text-gray-700">I confirm deactivating this brand with products</span>
                                </label>
                            </div>
                        @endif
